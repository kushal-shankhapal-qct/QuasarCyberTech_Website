      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1280px', color: '#334155', fontFamily: TYPOGRAPHY.fontBody, lineHeight: 1.8, textAlign: 'left' }}>
          ...
          <p style={{ marginBottom: '40px' }}>
            Welcome to the QuasarCyberTech website (the "Site"). Please read these Terms of Use ("Terms") carefully, as they govern your access to and use of the Site. By using the Site, you acknowledge that you have read, understood, and agree to abide by these Terms. If you do not agree, please do not access or use the Site.
            <br /><br />
            QuasarCyberTech reserves the right to update or modify these Terms at its sole discretion, without prior notice. Any changes will be effective immediately upon posting on the Site. It is your responsibility to review the Terms periodically. Your continued use of the Site following any updates constitutes acceptance of those changes.
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            The Site provides information about QuasarCyberTech's products, services, and other related content. Visitors and users of the Site are referred to as "Users."
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            ...
            <br /><br />
            By registering, you consent to receive communications from QuasarCyberTech, including emails, SMS, or phone calls. You can opt out of these communications by following the unsubscribe instructions in any message or by contacting us directly.
          </p>
          ...
          <p style={{ marginBottom: '16px' }}>
            You may use the Site for lawful purposes only. QuasarCyberTech reserves the right to modify or discontinue the Site at any time. Your use may be suspended or terminated for any violation of these Terms, at QuasarCyberTech's discretion, without notice. By using the Site, you agree to:
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            QuasarCyberTech may take appropriate action, including cooperating with law enforcement, for any violations.
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            QuasarCyberTech grants you a limited, non-exclusive, non-transferable license to access and use the Site for lawful purposes. You may not download or modify any part of the Site without prior written consent. Unauthorized use will result in termination of your license.
            <br /><br />
            By submitting content to the Site, you grant QuasarCyberTech a perpetual, worldwide license to use, display, and distribute your submission. You warrant that you have the legal right to share this content and that it does not violate third-party rights.
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            All content on the Site, including trademarks, logos, text, graphics, and software, is the exclusive property of QuasarCyberTech or its licensors. You may not copy, reproduce, distribute, or otherwise exploit any part of the Site without explicit permission from QuasarCyberTech.
            <br /><br />
          ...
          <p style={{ marginBottom: '40px' }}>
            The Site may contain links to external websites. These links are provided for convenience only, and QuasarCyberTech does not endorse or assume responsibility for the content or privacy practices of those websites. Your use of third-party sites is at your own risk.
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            QuasarCyberTech respects your privacy. Please refer to our Privacy Policy, which governs the handling of your personal information. By accessing the Site, you agree to the terms of the Privacy Policy.
          </p>

          <h3 style={{ color: '#0B1F3B', fontSize: '1.5rem', fontWeight: 700, fontFamily: TYPOGRAPHY.fontHeading, marginBottom: '16px' }}>DMCA Notice</h3>
          <p style={{ marginBottom: '40px' }}>
            QuasarCyberTech respects intellectual property rights. If you believe that content on the Site infringes your copyright, please contact us at contactus@quasarcybertech.com.
          </p>

          <h3 style={{ color: '#0B1F3B', fontSize: '1.5rem', fontWeight: 700, fontFamily: TYPOGRAPHY.fontHeading, marginBottom: '16px' }}>Notices</h3>
          <p style={{ marginBottom: '40px' }}>
            Notices may be sent to you via email, general posting on the Site, or conventional mail. You may contact QuasarCyberTech through the Contact Us form on the Site or via email.
          </p>
          ...
          <p style={{ marginBottom: '40px' }}>
            These Terms were last updated on October 24, 2024. QuasarCyberTech reserves the right to modify these Terms, and you should check this page periodically for updates.
          </p>
